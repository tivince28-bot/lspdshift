...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DEyUxw4p.js
var router_DEyUxw4p_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DKZPL1ok.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Los Santos territory desk — map gangs, draw turf, drop marks."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-BeM9Gt4p.mjs");
...
//#endregion
export { getRouter, router_DEyUxw4p_exports as t };
